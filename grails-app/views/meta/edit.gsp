                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="meta.name.label" default="Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: metaInstance, field: 'name', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="value"><g:message code="meta.value.label" default="Value" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: metaInstance, field: 'value', 'errors')}">
